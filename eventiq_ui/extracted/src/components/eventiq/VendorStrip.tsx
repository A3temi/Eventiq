          ...
          {vendors.map((v) => {
            ...
            return (
              <button
                key={v.id}
                onClick={() => onOpen(v.id)}
                className="group relative shrink-0 w-[260px] snap-start text-left rounded-2xl border border-border bg-card hover:bg-muted/40 hover:border-primary/40 transition p-4"
              >
